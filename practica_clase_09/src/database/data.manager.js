...
async function create(producto) {
    if (!producto?.marca || !producto?.talle || !producto?.modelo) throw new Error("Error. Datos incompletos.");
...
async function update(producto) {
    if (!producto?.id || !producto?.marca || !producto?.talle || !producto?.modelo) throw new Error("Error. Datos incompletos.");
